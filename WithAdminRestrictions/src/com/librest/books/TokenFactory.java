...
public class TokenFactory {
	...
	public boolean isValid(String jwtSent, String roleNeeded){
		JSONObject tokenConsumed= this.tokenConsume(jwtSent);
		if(tokenConsumed.length()>1){
			  try {
				  if(tokenConsumed.getInt("ID")>0 && tokenConsumed.getString("Role").equals(roleNeeded)) return true;
				}catch(JSONException e){
					e.printStackTrace();
				}
		  }
